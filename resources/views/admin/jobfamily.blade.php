        ...
        aria-labelledby="addDataLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/addJobFamily" method="POST" autocomplete="off">
                        {{ csrf_field() }}
...
{data: 'action', name: 'action', orderable: false, searchable: false}
                ]});}function addFunction() {$('#id').attr('readonly', true); 
...
$('#btnsubmit').prop("disabled",true); 
        ...
        function readonly(params) {
          $('#id').attr('readonly', params); $('#kode').attr('readonly', params); $('#nama').attr('readonly', params);  }
