        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/addTicket" method="POST" autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <label for="file_sisipan" id='file_sisipan'>Sisipan File</label>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control" id="status">
                                ...
                                <option value="PRS">Progress</option>
                                <option value="SLS">Selesai</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="tgl_selesai">tgl_selesai</label>
                            <input type="text" name="tgl_selesai" class="form-control" id="tgl_selesai" readonly>
                        </div>
                        <div class="form-group">
                            <label for="detail">tindakan</label>
                            <textarea type="text" rows="3" name="tindakan" class="form-control" id="tindakan"></textarea>
        ...
        async function viewFunction($id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.file_sisipan != null) {
                        $("#file_sisipan").empty();
                        $("#file_sisipan").append('Sisipan File :  <a href="{{ config('constant.imageTicket') }}' +
                         data.file_sisipan +'" target=\"_blank\"">' +
                         data.file_sisipan.substring(11) + '</a>');
                    }
